...
RUN yum install -y php72w-fpm php72w-mysql php72w-mbstring php72w-gd php72w-cli php72w-devel php72w-mcrypt php72w-pdo php72w-pecl-redis php72w-xml gcc gcc-c++ autoconf pcre-devel
