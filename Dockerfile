...
RUN yum install -y php71w-fpm php71w-common php71w-mysql php71w-mbstring php71w-gd php71w-cli php71w-devel php71w-mcrypt php71w-pdo php71w-pecl-redis php71w-xml gcc gcc-c++ autoconf pcre-devel
